(function (window, document) {
   ...
   * UI.Slider
   */
  angular.module('ui.slider', ['ngTouch']).value('uiSliderConfig', {}).controller('uiSliderController', [
    '$element',
    function uiSliderCtrl($element) {
    ...
    return {
      ...
      compile: function (tElement) {
        if (tElement.children().length === 0) {
          ...
          tElement.append('<div class="ui-slider__thumb" ng-model="__' + Math.random().toString(36).substring(7) + '"></div>');
        }
